...
#include "../../../../qgeoview-src/lib/include/QGeoView/Raster/QGVIcon.h"
...
static constexpr auto qt_meta_stringdata_ZN7QGVIconE = QtMocHelpers::stringData(
    "QGVIcon"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7QGVIconE[] = {
...
Q_CONSTINIT const QMetaObject QGVIcon::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7QGVIconE.offsetsAndSizes,
    qt_meta_data_ZN7QGVIconE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7QGVIconE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QGVIcon, std::true_type>
    >,
    nullptr
} };
...
void *QGVIcon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7QGVIconE.stringdata0))
