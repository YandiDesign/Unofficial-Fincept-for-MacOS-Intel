...
#include "../../../../qgeoview-src/lib/include/QGeoView/QGVMapQGView.h"
...
static constexpr auto qt_meta_stringdata_ZN12QGVMapQGViewE = QtMocHelpers::stringData(
    "QGVMapQGView",
    "dropData",
    "",
    "position",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12QGVMapQGViewE[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QPointF, 0x80000000 | 4,    3,    1,
...
Q_CONSTINIT const QMetaObject QGVMapQGView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12QGVMapQGViewE.offsetsAndSizes,
    qt_meta_data_ZN12QGVMapQGViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12QGVMapQGViewE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QGVMapQGView, std::true_type>,
        // method 'dropData'
...
void QGVMapQGView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QGVMapQGView::*)(QPointF , const QMimeData * );
            if (_q_method_type _q_method = &QGVMapQGView::dropData; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QGVMapQGView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12QGVMapQGViewE.stringdata0))
