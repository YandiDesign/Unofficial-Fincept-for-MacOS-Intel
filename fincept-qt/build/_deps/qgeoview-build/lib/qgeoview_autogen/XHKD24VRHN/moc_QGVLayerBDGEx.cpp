...
#include "../../../../qgeoview-src/lib/include/QGeoView/QGVLayerBDGEx.h"
...
static constexpr auto qt_meta_stringdata_ZN13QGVLayerBDGExE = QtMocHelpers::stringData(
    "QGVLayerBDGEx"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13QGVLayerBDGExE[] = {
...
Q_CONSTINIT const QMetaObject QGVLayerBDGEx::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13QGVLayerBDGExE.offsetsAndSizes,
    qt_meta_data_ZN13QGVLayerBDGExE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13QGVLayerBDGExE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QGVLayerBDGEx, std::true_type>
    >,
    nullptr
} };
...
void *QGVLayerBDGEx::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13QGVLayerBDGExE.stringdata0))
