...
#include "../../../src/services/equity/EquityResearchService.h"
...
Q_CONSTINIT static const uint qt_meta_data_ZN7fincept8services6equity21EquityResearchServiceE[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
      ...
      11,    2,   83,    2, 0x06,    7 /* Public */,
      15,    1,   88,    2, 0x06,   10 /* Public */,
      18,    1,   91,    2, 0x06,   12 /* Public */,
      20,    1,   94,    2, 0x06,   14 /* Public */,
      23,    2,   97,    2, 0x06,   16 /* Public */,
      26,    3,  102,    2, 0x06,   19 /* Public */,
      32,    2,  109,    2, 0x06,   23 /* Public */,
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::QString, 0x80000000 | 28, 0x80000000 | 30,   27,   29,   31,
...
void fincept::services::equity::EquityResearchService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->talipp_result((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QList<double>>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QList<qint64>>>(_a[3]))); break;
        case 9: _t->error_occurred((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (EquityResearchService::*)(QString , QVector<double> , QVector<qint64> );
            if (_q_method_type _q_method = &EquityResearchService::talipp_result; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 8;
                return;
            }
        }
...
// SIGNAL 8
void fincept::services::equity::EquityResearchService::talipp_result(QString _t1, QVector<double> _t2, QVector<qint64> _t3)
{
