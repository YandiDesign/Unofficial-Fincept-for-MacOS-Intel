...
#include "../../../src/trading/AccountDataStream.h"
...
void fincept::trading::AccountDataStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (AccountDataStream::*)(const QString & , const QVector<QPair<double,double>> & , const QVector<QPair<double,double>> & , double , double );
...
// SIGNAL 7
void fincept::trading::AccountDataStream::orderbook_fetched(const QString & _t1, const QVector<QPair<double,double>> & _t2, const QVector<QPair<double,double>> & _t3, double _t4, double _t5)
{
