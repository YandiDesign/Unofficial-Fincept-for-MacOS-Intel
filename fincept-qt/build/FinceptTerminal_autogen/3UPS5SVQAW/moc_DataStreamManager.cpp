...
#include "../../../src/trading/DataStreamManager.h"
...
Q_CONSTINIT static const uint qt_meta_data_ZN7fincept7trading17DataStreamManagerE[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
      ...
      25,    5,  135,    2, 0x06,   23 /* Public */,
      31,    2,  146,    2, 0x06,   29 /* Public */,
      34,    2,  151,    2, 0x06,   32 /* Public */,
      37,    2,  156,    2, 0x06,   35 /* Public */,
      40,    2,  161,    2, 0x06,   38 /* Public */,
      43,    2,  166,    2, 0x06,   41 /* Public */,
      46,    1,  171,    2, 0x06,   44 /* Public */,
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::QString, 0x80000000 | 26, 0x80000000 | 26, QMetaType::Double, QMetaType::Double,    3,   27,   28,   29,   30,
...
void fincept::trading::DataStreamManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->orderbook_fetched((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QList<std::pair<double,double>>>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QList<std::pair<double,double>>>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[4])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[5]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DataStreamManager::*)(const QString & , const QString & , const BrokerQuote & );
            if (_q_method_type _q_method = &DataStreamManager::quote_updated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (DataStreamManager::*)(const QString & , const QVector<BrokerQuote> & );
            if (_q_method_type _q_method = &DataStreamManager::watchlist_updated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (DataStreamManager::*)(const QString & , const QVector<BrokerPosition> & );
            if (_q_method_type _q_method = &DataStreamManager::positions_updated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (DataStreamManager::*)(const QString & , const QVector<BrokerHolding> & );
            if (_q_method_type _q_method = &DataStreamManager::holdings_updated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (DataStreamManager::*)(const QString & , const QVector<BrokerOrderInfo> & );
            if (_q_method_type _q_method = &DataStreamManager::orders_updated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (DataStreamManager::*)(const QString & , const BrokerFunds & );
            if (_q_method_type _q_method = &DataStreamManager::funds_updated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        ...
        {
            using _q_method_type = void (DataStreamManager::*)(const QString & , const QVector<QPair<double,double>> & , const QVector<QPair<double,double>> & , double , double );
...
// SIGNAL 0
void fincept::trading::DataStreamManager::quote_updated(const QString & _t1, const QString & _t2, const BrokerQuote & _t3)
{
...
// SIGNAL 1
void fincept::trading::DataStreamManager::watchlist_updated(const QString & _t1, const QVector<BrokerQuote> & _t2)
{
...
// SIGNAL 2
void fincept::trading::DataStreamManager::positions_updated(const QString & _t1, const QVector<BrokerPosition> & _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
...
// SIGNAL 3
void fincept::trading::DataStreamManager::holdings_updated(const QString & _t1, const QVector<BrokerHolding> & _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
...
// SIGNAL 4
void fincept::trading::DataStreamManager::orders_updated(const QString & _t1, const QVector<BrokerOrderInfo> & _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
...
// SIGNAL 5
void fincept::trading::DataStreamManager::funds_updated(const QString & _t1, const BrokerFunds & _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
...
// SIGNAL 7
void fincept::trading::DataStreamManager::orderbook_fetched(const QString & _t1, const QVector<QPair<double,double>> & _t2, const QVector<QPair<double,double>> & _t3, double _t4, double _t5)
{
