...
#include "../../../src/services/news/NewsService.h"
...
Q_CONSTINIT static const uint qt_meta_data_ZN7fincept8services11NewsServiceE[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, 0x80000000 | 3, QMetaType::Int, QMetaType::Int,    4,    9,   10,
...
Q_CONSTINIT const QMetaObject fincept::services::NewsService::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7fincept8services11NewsServiceE_t,
        ...
        // method 'analysis_ready'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<NewsAnalysis, std::false_type>,
...
void fincept::services::NewsService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->analysis_ready((*reinterpret_cast< std::add_pointer_t<NewsAnalysis>>(_a[1]))); break;
        case 2: _t->articles_partial((*reinterpret_cast< std::add_pointer_t<QList<NewsArticle>>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (NewsService::*)(NewsAnalysis );
            if (_q_method_type _q_method = &NewsService::analysis_ready; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void fincept::services::NewsService::analysis_ready(NewsAnalysis _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
